...
- [ ] RF-7. First menu item shold be called 'Analyze'. Submenu items: 'all', 'Users contribution' (RF-8), 'Most active hours' (RF-9), 'Most active week days'  (RF-10), 'Repository project size'  (RF-10).
- [ ] RF-8. 'Users contribution' should show all users with their contribution statistics. What should be calculated: commits, lines added/deleted, net contribution, files touched, and active days per contributor.
